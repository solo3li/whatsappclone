...
public record MessageDto(Guid Id, string Text, Guid SenderId, string SenderName, DateTime Time, bool IsMe, string? Image, string? Audio, string? FileUri, string? FileName, string? FileSize, Guid? ReplyToId, string? ReplyText);
